...
- 最后更新：2026-06-04（M0–M4 主体 ✅ + **LSP 核心 ✅(补全/诊断/悬停/转到定义,对真实 rust-analyzer e2e)** + **新 logo + 文件关联 + 状态栏入口 + AI Agent 侧栏** + 对抗式审查修 21 真 bug;**已发 v0.0.8(4 平台逐版 CI 绿)**;pantheon 路线图 A/B(UI)/C/D 完成,E 待证书)
